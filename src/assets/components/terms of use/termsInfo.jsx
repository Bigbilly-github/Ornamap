...
function TermsInfo (){
    ...
    return(
        <>
            <div className={styles.privacyInfo} style={style1}>
                    
                    <div className={styles.privacyQuestions} style={style}>
                        <a href=''>App Usage</a>
                        <a  href=''>Privacy</a>
                        <a  href=''>Refund Policy</a>
                        <a  href=''>Limitation of Liability</a>
                        <a  href=''>Third-Party Links</a>
                        <a  href=''>Governing Law and Jurisdiction</a>
                        <a  href=''>Anti-Money Laundering Policy</a>
                    ...
                    <div className={styles.privacyAnswers} > 
                        <div className={styles.policy} >
                                <h1 style={style2}>Terms of Use</h1>
                        ...
                        <div className={styles.answers}>
                           ...
                           <h3 >
                            ...
                            <p >
                            (i.) Purpose: OrnaMap is designed to provide information and services related to train and ferry transportation, aiming to enhance your travel experience.
                            </p>
                            <p >
                            (ii.) User Responsibilities: You are responsible for using the App in accordance with applicable laws and regulations. Any unauthorised use or violation of these Terms may result in the termination of your access to the App
                            </p>
                            ...
                            <p >
                            For any refund-related queries or to report a transaction issue, please contact our customer support team at support@ornamap.com. Our customer support is available Monday to Friday, from 9:00 AM to 5:00 PM (WAT).
                            </p>
                            <h3 >
                            Important Notes
                            </h3>
                            ...
                            <p >
                            We, at OrnaMap Technologies Limited are committed to providing a safe and secure platform for our users to plan their trips and fund their cowry cards in Nigeria. This Anti-Money Laundering (AML) Policy outlines the measures we take to prevent our app from being used for illegal activities such as money laundering
                            </p>
                            <h4 >
                            1. Customer Due Diligence (CDD)
                            </h4>
                            <p >
                            (i.) Verification: We require all users to register for an account with OrnaMap Technologies Limited. During registration, we collect basic user information such as name, phone number, and email address.
                            </p>
                            <h3 >
                            ...
                            <p >
                            (ii.) Cowry Wallet Verification: For users paying into their cowry wallets with OrnaMap Technologies Limited, we will implement procedures to verify the ownership and legitimacy of the cowry wallet. This may involve collaborating with the cowry wallet provider to obtain relevant information.
                            </p>
                            <p >
                            (iii.) Suspicious Activity Monitoring: We monitor user activity for suspicious patterns that could indicate money laundering, such as anonymous payment methods or frequent bookings with different accounts originating from the same location.
                            </p>
                            <h4 >
                            2. Customer Due Diligence (CDD)
                            </h4>
                            <p >
                            We set limits on the amount a user can fund their wallets with through the app in a single transaction. This helps us identify and flag unusually large transactions that could be suspicious.
                            </p>
                            <h4 >
                            3. KYC/AML for Cowry Wallets
                            </h4>
                            <p >
                            We will rely on Cowry to perform KYC (Know Your Customer) and AML checks on their users. This ensures that users linking their Cowry wallets to OrnaMap have already undergone identity verification.
                            </p>
                            ...
                            <p >
                            These Terms and Conditions create the entire agreement between you and OrnaMap. regarding your use of the App. If you have any questions or concerns about these Terms, please contact us at support@ornamap.com
                            </p>
                        </div>
